...
Репозитарий содержит материалы по итоговому занятию №9, посвященному работе с DOM средствами JavaScript.
...
**Закрепим практикой**
1. Найти в документе div с id `inputsBlock`. Результат поиска запишем в переменную `inputsBlock`.
