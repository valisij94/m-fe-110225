...
4. На одно из полей добавьте обработчик события клавиатуры onKeyDown. если нажата кнопка enter - выводим в консоль сообщение enter Pressed, иначе ничего не делаем.
